...
<asp:HyperLink ID="pageLink1" runat="server" Text="Home" NavigateUrl="~/Admin/index.aspx"></asp:HyperLink>
    ...
    <br />
    <asp:HyperLink ID="pageLink4" runat="server" NavigateUrl="~/Admin/Edit.aspx" Text="Edit Products" Enabled="False"></asp:HyperLink>
    <br />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 <form id="editform1" runat="server">
     <asp:Image ID="ImageProducts" runat="server" />   
     <asp:FormView ID="EditView1" runat="server" AllowPaging="True" DataSourceID="SqlDataSource1" DataKeyNames="Product_ID">
         <EditItemTemplate>
             Product_ID:
